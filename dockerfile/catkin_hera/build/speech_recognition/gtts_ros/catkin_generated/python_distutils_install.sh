...
echo_and_run cd "/workspace/dockerfile/catkin_hera/src/speech_recognition/gtts_ros"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/workspace/dockerfile/catkin_hera/src/speech_recognition/gtts_ros/setup.py" \
     \
    build --build-base "/workspace/dockerfile/catkin_hera/build/speech_recognition/gtts_ros" \
    install \
    --root="${DESTDIR-/}" \
