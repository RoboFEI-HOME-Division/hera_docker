...
echo_and_run cd "/workspace/dockerfile/catkin_hera/src/hera"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/workspace/dockerfile/catkin_hera/src/hera/setup.py" \
     \
    build --build-base "/workspace/dockerfile/catkin_hera/build/hera" \
    install \
    --root="${DESTDIR-/}" \
